...
# kernel path: results/my_experiment/torchinductor_cache_0/qd/cqd2dg5ecv65dwjdpn25z5v2t4trq26vlyyggfayqf532dbwlm3f.py
...
# kernel path: results/my_experiment/torchinductor_cache_0/2o/c2ogi4lsz6clsbkgmv2wfqm7ll6ueakx6jiukuenpfzu4nvjtq4o.py
...
def triton_red_fused__to_copy_add_mul_native_layer_norm_3(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr0, out_ptr1, out_ptr2, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    ...
    for r0_offset in range(0, r0_numel, R0_BLOCK):
        ...
        tl.store(out_ptr2 + (r0_2 + 1152*x3), tmp32, xmask & r0_mask)
''', device_str='cuda')
...
# kernel path: results/my_experiment/torchinductor_cache_0/na/cnavagwodhbdwjfxswrqgxc35jxkauzydnoyzm6ff3f6iryl3act.py
...
def call(args):
    ...
    args.clear()
    assert_size_stride(primals_1, (2, 256, 1152), (5013504, 1152, 1))
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        del primals_2
        buf2 = empty_strided_cuda((2, 256, 1152), (294912, 1152, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [linear], Original ATen: [aten.clone]
        stream0 = get_raw_stream(0)
        triton_poi_fused_clone_2.run(primals_1, buf2, 589824, stream=stream0)
        del primals_1
        buf3 = empty_strided_cuda((512, 1152), (1152, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [linear], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf2, (512, 1152), (1152, 1), 0), buf1, out=buf3)
        buf4 = empty_strided_cuda((2, 256, 1152), (294912, 1152, 1), torch.bfloat16)
        buf5 = empty_strided_cuda((2, 256, 1), (256, 1, 1), torch.float32)
        buf6 = empty_strided_cuda((2, 256, 1), (256, 1, 512), torch.float32)
        buf8 = reinterpret_tensor(buf6, (2, 256, 1), (256, 1, 1), 0); del buf6  # reuse
        buf9 = empty_strided_cuda((2, 256, 1152), (294912, 1152, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [linear, mul, add, add_1, layer_norm, mul_1, add_2, linear_1], Original ATen: [aten.add, aten.mul, aten._to_copy, aten.native_layer_norm]
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_mul_native_layer_norm_3.run(buf8, primals_5, primals_4, buf3, buf0, primals_6, primals_7, buf4, buf5, buf9, 512, 1152, stream=stream0)
        del primals_5
        del primals_7
        ...
        del primals_9
        buf12 = empty_strided_cuda((512, 4608), (4608, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [linear_1], Original ATen: [aten._to_copy, aten.addmm]
        extern_kernels.addmm(buf11, reinterpret_tensor(buf9, (512, 1152), (1152, 1), 0), reinterpret_tensor(buf10, (1152, 4608), (1, 1152), 0), alpha=1, beta=1, out=buf12)
        del buf11
        buf13 = empty_strided_cuda((2, 256, 4608), (1179648, 4608, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [gelu], Original ATen: [aten.gelu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_gelu_6.run(buf12, buf13, 2359296, stream=stream0)
    return (buf13, buf4, primals_4, primals_6, buf0, reinterpret_tensor(buf2, (512, 1152), (1152, 1), 0), buf3, buf4, buf5, buf8, reinterpret_tensor(buf9, (512, 1152), (1152, 1), 0), buf12, buf10, reinterpret_tensor(buf1, (1152, 1152), (1152, 1), 0), )


def benchmark_compiled_module(times=10, repeat=10):
    from torch._dynamo.testing import rand_strided
    from torch._inductor.utils import print_performance
    primals_1 = rand_strided((2, 256, 1152), (5013504, 1152, 1), device='cuda:0', dtype=torch.bfloat16)
