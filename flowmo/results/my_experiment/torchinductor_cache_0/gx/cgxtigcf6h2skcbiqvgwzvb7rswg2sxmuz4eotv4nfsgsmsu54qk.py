...
# kernel path: results/my_experiment/torchinductor_cache_0/kj/ckjyvrjg7owekwfrprtla44umi5xyksskwlyt752n7btfc2refp2.py
# Topologically Sorted Source Nodes: [rearrange_1], Original ATen: [aten.clone]
# Source node to ATen node mapping:
#   rearrange_1 => clone
# Graph fragment:
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_clone_8', 'mutated_arg_names': [], 'optimize_mem': False, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'backend_hash': '6769567BF9CB28FC4140E0A692BA44D0F6558D1D18952489FF33DAF4A85D2E95', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
...
# kernel path: results/my_experiment/torchinductor_cache_0/uv/cuvgb42iobgfemzzjst7jnkfdyxttzrwb7lwolrmmyg7hx7zxy2u.py
...
triton_poi_fused__to_copy_t_9 = async_compile.triton('triton_poi_fused__to_copy_t_9', '''
import triton
import triton.language as tl
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*fp32', 'out_ptr0': '*bf16', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=82, cc=86, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy_t_9', 'mutated_arg_names': [], 'optimize_mem': False, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'backend_hash': '6769567BF9CB28FC4140E0A692BA44D0F6558D1D18952489FF33DAF4A85D2E95', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
...
# kernel path: results/my_experiment/torchinductor_cache_0/3d/c3dc2imzp2eykl6ahisl7aga627kznurxzkzkcmnlcvtjwqidac2.py
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*bf16', 'out_ptr0': '*bf16', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=82, cc=86, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_clone_10', 'mutated_arg_names': [], 'optimize_mem': False, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'backend_hash': '6769567BF9CB28FC4140E0A692BA44D0F6558D1D18952489FF33DAF4A85D2E95', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
...
# kernel path: results/my_experiment/torchinductor_cache_0/fj/cfjvgo5yg57k5smnmulvey6azzcf6uifbjnrj7whzvtopp2ct4p6.py
...
triton_per_fused__to_copy_add_mul_native_layer_norm_11 = async_compile.triton('triton_per_fused__to_copy_add_mul_native_layer_norm_11', '''
import triton
import triton.language as tl
...
@triton_heuristics.persistent_reduction(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__to_copy_add_mul_native_layer_norm_11', 'mutated_arg_names': ['in_out_ptr0', 'in_out_ptr1'], 'optimize_mem': False, 'no_x_dim': True, 'num_load': 3, 'num_reduction': 4, 'backend_hash': '6769567BF9CB28FC4140E0A692BA44D0F6558D1D18952489FF33DAF4A85D2E95', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False}
)
@triton.jit
def triton_per_fused__to_copy_add_mul_native_layer_norm_11(in_out_ptr0, in_out_ptr1, in_ptr0, in_ptr1, out_ptr0, out_ptr1, xnumel, r0_numel):
    xnumel = 8192
...
# kernel path: results/my_experiment/torchinductor_cache_0/ca/ccavunj2hd4urm2uh42jma5ojs2steoi7jvsatgz7ea3faasmbes.py
...
# kernel path: results/my_experiment/torchinductor_cache_0/is/cisz7immec56tslrhmzdz2xfthucg6sl25redkjdzpe2i3soybw4.py
# Topologically Sorted Source Nodes: [linear_2], Original ATen: [aten._to_copy]
# Source node to ATen node mapping:
...
# kernel path: results/my_experiment/torchinductor_cache_0/fq/cfq7ow6ub4ddcf4ilhr62lzxfa22vxnihpwxn56w5sdrxjy46uoo.py
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*bf16', 'out_ptr0': '*bf16', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=82, cc=86, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_gelu_14', 'mutated_arg_names': [], 'optimize_mem': False, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'backend_hash': '6769567BF9CB28FC4140E0A692BA44D0F6558D1D18952489FF33DAF4A85D2E95', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
...
# kernel path: results/my_experiment/torchinductor_cache_0/j7/cj75k5cii3u7o4wiss264tihqhtunoekjveig6i627wpq6lyp325.py
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        del buf13
        buf19 = empty_strided_cuda((2, 4352, 12, 64), (3342336, 768, 64, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [rearrange_1], Original ATen: [aten.clone]
        stream0 = get_raw_stream(0)
        triton_poi_fused_clone_8.run(buf14, buf19, 6684672, stream=stream0)
        buf20 = empty_strided_cuda((768, 768), (1, 768), torch.bfloat16)
        # Topologically Sorted Source Nodes: [linear_1], Original ATen: [aten._to_copy, aten.t]
        stream0 = get_raw_stream(0)
        triton_poi_fused__to_copy_t_9.run(primals_10, buf20, 589824, stream=stream0)
        del primals_10
        buf21 = empty_strided_cuda((2, 4096, 768), (3145728, 768, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [linear_1], Original ATen: [aten.clone]
        stream0 = get_raw_stream(0)
        triton_poi_fused_clone_10.run(buf19, buf21, 6291456, stream=stream0)
        buf22 = empty_strided_cuda((8192, 768), (768, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [linear_1], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf21, (8192, 768), (768, 1), 0), buf20, out=buf22)
        buf23 = reinterpret_tensor(buf22, (2, 4096, 768), (3145728, 768, 1), 0); del buf22  # reuse
        buf24 = empty_strided_cuda((2, 4096, 1), (4096, 1, 1), torch.float32)
        buf25 = empty_strided_cuda((2, 4096, 1), (4096, 1, 8192), torch.float32)
        buf27 = reinterpret_tensor(buf25, (2, 4096, 1), (4096, 1, 1), 0); del buf25  # reuse
        buf28 = empty_strided_cuda((2, 4096, 768), (3145728, 768, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [linear_1, mul_8, add_4, layer_norm, mul_9, add_5, linear_2], Original ATen: [aten._to_copy, aten.add, aten.mul, aten.native_layer_norm]
        stream0 = get_raw_stream(0)
        triton_per_fused__to_copy_add_mul_native_layer_norm_11.run(buf23, buf27, primals_12, primals_11, buf24, buf28, 8192, 768, stream=stream0)
        del primals_11
        del primals_12
        buf29 = empty_strided_cuda((3072, 768), (768, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [linear_2], Original ATen: [aten._to_copy]
        stream0 = get_raw_stream(0)
        triton_poi_fused__to_copy_12.run(primals_13, buf29, 2359296, stream=stream0)
        del primals_13
        buf30 = empty_strided_cuda((3072, ), (1, ), torch.bfloat16)
        # Topologically Sorted Source Nodes: [linear_2], Original ATen: [aten._to_copy]
        stream0 = get_raw_stream(0)
        triton_poi_fused__to_copy_13.run(primals_14, buf30, 3072, stream=stream0)
        del primals_14
        buf31 = empty_strided_cuda((8192, 3072), (3072, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [linear_2], Original ATen: [aten._to_copy, aten.addmm]
        extern_kernels.addmm(buf30, reinterpret_tensor(buf28, (8192, 768), (768, 1), 0), reinterpret_tensor(buf29, (768, 3072), (1, 768), 0), alpha=1, beta=1, out=buf31)
        del buf30
        buf32 = empty_strided_cuda((2, 4096, 3072), (12582912, 3072, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [gelu], Original ATen: [aten.gelu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_gelu_14.run(buf31, buf32, 25165824, stream=stream0)
        buf33 = empty_strided_cuda((3072, 768), (1, 3072), torch.bfloat16)
        # Topologically Sorted Source Nodes: [linear_3], Original ATen: [aten._to_copy, aten.t]
        stream0 = get_raw_stream(0)
        triton_poi_fused__to_copy_12.run(primals_15, buf33, 2359296, stream=stream0)
        del primals_15
        buf34 = empty_strided_cuda((8192, 768), (768, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [linear_3], Original ATen: [aten.addmm]
        extern_kernels.mm(reinterpret_tensor(buf32, (8192, 3072), (3072, 1), 0), buf33, out=buf34)
        buf35 = reinterpret_tensor(buf34, (2, 4096, 768), (3145728, 768, 1), 0); del buf34  # reuse
        # Topologically Sorted Source Nodes: [mul_10, add_6], Original ATen: [aten.mul, aten.add]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_mul_15.run(buf35, buf23, primals_16, 6291456, stream=stream0)
        del primals_16
    return (reinterpret_tensor(buf19, (2, 256, 768), (3342336, 768, 1), 0), buf35, primals_4, primals_5, primals_9, reinterpret_tensor(buf0, (512, 768), (768, 1), 0), reinterpret_tensor(buf3, (2, 12, 256, 64), (589824, 64, 2304, 1), 0), reinterpret_tensor(buf3, (2, 12, 256, 64), (589824, 64, 2304, 1), 768), buf5, buf7, buf8, buf11, buf12, buf14, buf15, buf16, buf17, reinterpret_tensor(buf21, (8192, 768), (768, 1), 0), buf23, buf24, buf27, reinterpret_tensor(buf28, (8192, 768), (768, 1), 0), buf31, reinterpret_tensor(buf32, (8192, 3072), (3072, 1), 0), reinterpret_tensor(buf33, (768, 3072), (3072, 1), 0), buf29, reinterpret_tensor(buf20, (768, 768), (768, 1), 0), buf1, )
