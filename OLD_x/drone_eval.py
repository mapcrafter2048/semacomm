...
def load_flowmo_model_for_eval(model_path, context_dim=18, config_path="flowmo/configs/base.yaml"):
    """Load a pretrained FlowMo model using the base config for evaluation."""
    ...
    # Adjust for potential DataParallel or DistributedDataParallel prefixes
    new_state_dict = {}
...
def main():
    ...
    model = load_flowmo_model_for_eval(args.checkpoint, args.context_dim, args.config_path)
